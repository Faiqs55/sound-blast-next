...
const Footer = () => {
  return (
    <div className='flex justify-between w-full gap-4 text-white pb-28 pt-5 bg-[#111] px-10 flex-wrap'>
        <div className='lg:w-[17%]'>
            <h3 className='text-lg mb-2 font-semibold'>Company</h3>
            <ul className='font-semibold text-gray-400 flex flex-col gap-2'>
        ...
        <div className='lg:w-[17%]'>
            <h3 className='text-lg mb-2 font-semibold'>Communities</h3>
        <ul className='font-semibold text-gray-400 flex flex-col gap-2'>
        ...
        <div className='lg:w-[17%]'>
            <h3 className='text-lg mb-2 font-semibold'>Usefull Links</h3>
        <ul className='font-semibold text-gray-400 flex flex-col gap-2'>
        ...
        <div className='lg:w-[17%]'>
            <h3 className='text-lg mb-2 font-semibold'>SoundBlast Plans</h3>
        <ul className='font-semibold text-gray-400 flex flex-col gap-2'>
